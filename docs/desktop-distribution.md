...
npm run release:desktop:evidence-workflow -- --repo JoeWorkspace/JoeSSH --ref v0.1.0-beta.7
```
...
```bash
git tag -a v0.1.0-beta.7 -m "JoeSSH 0.1.0-beta.7"
...
command then requires `docs/release-notes/0.1.0-beta.7.md`, staged release artifacts under
