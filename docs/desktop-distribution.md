...
npm run release:desktop:evidence-workflow -- --repo JoeWorkspace/JoeSSH --ref v0.1.0-beta.8
```
...
command then requires `docs/release-notes/0.1.0-beta.8.md`, staged release artifacts under
