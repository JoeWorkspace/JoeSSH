export const ptBR = {
  ...
  "mobile.readyMessage": "Este dispositivo está registrado e o contexto atual do terminal está disponível.",
  "mobile.offline": "Fallback offline ativo",
  "mobile.offlineMessage": "A sincronização ao vivo está indisponível, mas o contexto em cache e os caminhos de recuperação estão visíveis.",
  ...
  "mobile.emptyRoutes": "As rotas de emergência aparecem após a primeira prévia.",
