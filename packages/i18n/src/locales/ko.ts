export const ko = {
  ...
  "desktop.telemetryErrors": "오류 텔레메트리",
  ...
  "mobile.readyMessage": "이 장치는 등록되었으며 현재 터미널 컨텍스트를 사용할 수 있습니다.",
  "mobile.offline": "오프라인 대체 경로 활성",
  "mobile.offlineMessage": "실시간 동기화는 사용할 수 없지만 캐시된 컨텍스트와 복구 경로는 표시됩니다.",
  ...
  "mobile.pendingChanges": "대기 중인 변경",
  ...
  "mobile.emptyRoutes": "긴급 경로는 첫 미리보기 후 표시됩니다.",
