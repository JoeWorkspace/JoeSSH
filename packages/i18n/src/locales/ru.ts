export const ru = {
  ...
  "mobile.readyMessage": "Это устройство зарегистрировано, текущий контекст терминала доступен.",
  "mobile.offline": "Офлайн-резерв активен",
  "mobile.offlineMessage": "Живая синхронизация недоступна, но кэшированный контекст и пути восстановления видны.",
  ...
  "mobile.emptyRoutes": "Аварийные маршруты появятся после первого предпросмотра.",
