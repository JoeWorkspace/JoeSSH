export const id = {
  ...
  "desktop.telemetryErrors": "Telemetri error",
  ...
  "web.telemetryErrors": "Telemetri error",
  ...
  "mobile.readyMessage": "Perangkat ini terdaftar dan konteks terminal saat ini tersedia.",
  "mobile.offline": "Cadangan offline aktif",
  "mobile.offlineMessage": "Sinkronisasi langsung tidak tersedia, tetapi konteks cache dan jalur pemulihan terlihat.",
  ...
  "mobile.pendingChanges": "Perubahan tertunda",
  ...
  "mobile.emptyRoutes": "Rute darurat muncul setelah pratinjau pertama.",
