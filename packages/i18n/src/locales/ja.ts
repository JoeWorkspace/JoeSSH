export const ja = {
  ...
  "desktop.telemetryErrors": "エラーテレメトリ",
  ...
  "mobile.readyMessage": "このデバイスは登録済みで、現在のターミナルコンテキストを利用できます。",
  "mobile.offline": "オフラインフォールバック有効",
  "mobile.offlineMessage": "ライブ同期は利用できませんが、キャッシュ済みコンテキストと復旧経路を表示できます。",
  ...
  "mobile.emptyRoutes": "緊急ルートは最初のプレビュー後に表示されます。",
